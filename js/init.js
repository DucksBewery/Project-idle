...
var nourriture = new Ressource("nourriture","nourritureMax",5000,0);
...
//constructions//
var nid = new Structure("nid",2,0);
var moulin = new Structure("moulin",2,0);
var camp = new Structure("camp",2,0);
var champCrouton = new Structure("champCrouton",2,1);
var champMalt = new Structure("champMalt",2,0);
var champHoublon = new Structure("champHoublon",2,0);
var champOrge = new Structure("champOrge",2,0);
